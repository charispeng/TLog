...
import com.yomahub.tlog.core.utils.TLogAspectUtils;
...
public class AspectLogAop {
    ...
    public Object around(ProceedingJoinPoint jp) throws Throwable {
        //拿到之前的标签
        String oldLogValue = AspectLogContext.getLogValue();
        ...
        try {
            ...
            TLogAspectUtils.push(tlogAspect);
            ...
            if (StringUtils.isNotBlank(aspLogValue)) {
                ...
                MDC.put(TLogConstants.MDC_KEY, oldLogValue + " " + aspLogValue);
                AspectLogContext.putLogValue(oldLogValue + " " + aspLogValue);
            }
            ...
            if (fillSuccessful) {
                // 将旧值设置回去，解决嵌套调用的问题
                if (StrUtil.isNotBlank(oldLogValue)) {
                    MDC.put(TLogConstants.MDC_KEY, oldLogValue);
                    AspectLogContext.putLogValue(oldLogValue);
                }
            }
        }
    }
